...
这个仓库收集了泛函本机正在使用的一组 Agent skill，共 130 个。

我把它们分成两类：

- `self-created/`：泛函自己沉淀出来的定制 skill，共 38 个。
...
| 泛函视觉设计系统 | 把泛函个人网站的品牌视觉复用到网页、演示、3:4 卡片与长图海报。 | `self-created/fanhan-visual-design-system` |
